...
/**
 * Singleton providing all the Signal-related facilities.
 * This object delivers the key entities: the <code>Signal</code> class and the 
 * <code>SignalEmitter</code> trait.
